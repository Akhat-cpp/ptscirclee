...
(function() {
  ...
  run( (time, ftime) => {
    ...
    if(ins2.length > 0)
    {
        c1 =  Math.sqrt(add(multiply(subtract(space.center.x, xy.x), subtract(space.center.x, xy.x)) , multiply((subtract(space.center.y, xy.y), subtract(space.center.y, xy.y)))))
        c2 =  Math.sqrt(add(multiply(subtract(space.center.x, xy.x), subtract(space.center.x, xy.x)) , multiply((subtract(space.center.y, xy.y), subtract(space.center.y, xy.y)))))
    }
    if(ins2.length == 0)
    {
